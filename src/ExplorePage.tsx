...
import { Server, Code, Database, BrainCircuit, Wind, Layers, Cloud } from 'lucide-react';
...
const ExplorePage = () => {
  const architectureSections = [
    ...
    },
    {
      ...
      techs: ["Node.js", "Express.js", "REST API,","TypeScript"]
    },
    {
    ...
    },
    {
      icon: <Cloud size={24} />,
      title: "Deployment",
        description: "The backend is hosted on Render, with the frontend deployed on Vercel for optimal performance and continuous delivery.",
      techs: ["Render", "Vercel"]
    },
    {
        title: "Text Extactors",
        icon: <Code size={24} />,
        description: "Various text extractors are employed to handle different document formats, ensuring accurate text retrieval for summarization.",
        techs: ["PDF.js", "Tesseract.js", "Mammoth.js"]
    }
  ];
